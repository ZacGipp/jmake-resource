...
ntv.msg.common = {
 ...
 /*--STB Coship
  ====================================================== */
 ntv.msg.coship = function(){};
 ntv.msg.coship.init = function(){
	 ntv.stb.coship.mediaplayer.msg = this.dev.mediaplayer;
 };

 ntv.msg.coship.dev = function(){};
 ntv.msg.coship.dev.mediaplayer = {
	 // MediaPlayer对象
	 getNativePlayerInstanceId: "获得接收终端本地可用的播放器实例ID: ",
	 bindNativePlayerInstance:  "MediaPlayer对象与播放器实例绑定: ",
	 releaseMediaPlayer: "MediaPlayer对象和当前播放器实例解除绑定: ",
	 setSingleMedia:       "异步方法，设置待播放媒体的URL地址: ",
	 playFromStart:                 "异步方法，从媒体起始点开始播放: ",
	 seek:                 "异步方法，从当前媒体的某个时间点开始播放: ",
	 setPace:              "异步方法，设置播放步长: ",
	 pause:                "异步方法，暂停播放: ",
	 resume:               "异步方法，恢复播放: ",
	 stop:                 "异步方法，停止播放: ",
	 refreshVideoDisplay:              "刷新视频窗口: ",
...
ntv.msg.pcbrowser.dev.mediaplayer = {
 ...
 /*--STB iptv
  ====================================================== */
 ntv.msg.iptv = function(){};
 ntv.msg.iptv.init = function(){
	 ntv.stb.iptv_js.mediaplayer.msg = this.dev.mediaplayer;
 };

 ntv.msg.iptv.dev = function(){};
 ntv.msg.iptv.dev.mediaplayer = {
	 // MediaPlayer对象
	 getNativePlayerInstanceId: "获得接收终端本地可用的播放器实例ID: ",
	 bindNativePlayerInstance:  "MediaPlayer对象与播放器实例绑定: ",
	 releaseMediaPlayer: "MediaPlayer对象和当前播放器实例解除绑定: ",
